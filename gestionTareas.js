...
function mostrarTareasDevoluciones() {
    ...
    for (i = 0; i < tareasCreadas.length;) {
        ...
        document.querySelector("#tableTareaDevolucion").innerHTML = tablaDevoluciones;
    }
...
function mostrarTareaInfo() {
    ...
    let tareaSeleccionada = document.querySelector("#tareaSeleccionInfoDevoluciones").value;
